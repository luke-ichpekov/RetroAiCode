...
if __name__ == '__main__':
    env_id = "FerrariGrandPrixChallenge-Genesis"
    num_cpu = 10
    ...
    #model = PPO2(CnnPolicy, env=env, verbose=1, learning_rate=0.0003, cliprange_vf=-1, tensorboard_log="placeholder")
    model = PPO2.load('1Milliongrandprixferrari.zip', env)
    #model.learn(1000000, callback=eval_callback, tb_log_name="pacman1mil+run")
    #model.save("1Milliongrandpricksferrari")
    obs = env.reset()
    while True:
