...
if __name__ == '__main__':
    env_id = "FightingMasters-Genesis"
    num_cpu = 10
    ...
    model = PPO2.load('5milsamuraishowdown-nes.zip', env)
    #model.learn(5000000, tb_log_name="pacman1mil+run")
    #model.save("5milsamuraishowdown-nes")
    obs = env.reset()
    while True:
